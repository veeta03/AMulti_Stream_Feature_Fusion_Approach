"""amulti_stream_feature_fusion_approach URL Configuration
...
from amulti_stream_feature_fusion_approach import settings
...
urlpatterns = [
    ...
    url(r'^testregister/$', remoteuser.Register1, name="testregister"),
    ...
    url(r'^View_Prediction_Of_Traffic_Type_Ratio/$', serviceprovider.View_Prediction_Of_Traffic_Type_Ratio, name="View_Prediction_Of_Traffic_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_Traffic_Type/$', serviceprovider.View_Prediction_Of_Traffic_Type, name="View_Prediction_Of_Traffic_Type"),
